...
class _MapScreenState extends State<MapScreen> {
  ...
  static const CameraPosition _initialPosition = CameraPosition(
    target: LatLng(3.1390, 101.6869), // KL city center
    zoom: 12.0,
  );
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<FoodTruckProvider>().loadFoodTrucks();
    });
  }

  void _onMapCreated(GoogleMapController controller) {
    // Map controller can be stored if needed for map operations
  }
    ...
    return Scaffold(
      ...
      body: Consumer<FoodTruckProvider>(
        builder: (context, provider, child) {
          ...
          // Create markers when trucks are loaded
          _createMarkers(provider.foodTrucks);
